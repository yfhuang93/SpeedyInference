        ...
        while True:
            ...
            if step == 0:
                ...
                for step_draft in range(max_step_draft):
                    ...
                    # print(type(model),step,draft_output.keys())
                    draft_past_key_values = draft_output.past_key_values#['past_key_values']
                ...
                past_key_values = output.past_key_values#['past_key_values']
